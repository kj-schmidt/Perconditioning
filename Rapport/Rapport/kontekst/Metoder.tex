...
Denne metode bruges til at skabe struktur i \textit{Konditioneringsapparatets} software. 3-lags modellen sikre at der høj samhørighed og lav kobling mellem de tre lag. Det tre lag er som følger: \\
...
\textit{Logik laget: } Her håndteres udregninger, data processering og evalueringen. Dette lag fungere ydermere som kommunikationen lag mellem data og præsentationslag. 
\textit{Data laget: } Dette lag beskæftiger sig med data håndtering. Her håndteres kommunikation med databaser eller andre hukommelses forme. 

3-lags modellen sikre yderligere at software er logisk struktureret og vedligeholdelse af systemet bliver nemmere. 
