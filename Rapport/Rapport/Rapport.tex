\input{preamble_KJS_SVG}											% Preamble indlaeses
...
\include{intro/definitioner}
\include{intro/indledning}

%% Kontekst %%

\include{kontekst/Baggrund}
\include{kontekst/Problemformulering}
\include{kontekst/Projektafgraensninger}
\include{kontekst/Systembeskrivelse}
\include{kontekst/Metoder}
%\include{kontekst/Udviklingsdokumentation}
\include{kontekst/Resultater}
\include{kontekst/Diskussion}
\include{formalia/Perspektivering}
